...
#include "FlyingCharacterMovementComponent.h"
...
// * frame rates.
// ==============================================================================
void UFlyingCharacterMovementComponent::PhysFlying(float deltaTime, int32 Iterations)
{
	...
	while ((remainingTime >= MIN_TICK_TIME) && (Iterations < MaxSimulationIterations))
	{
		...
		APlaneCharacter* PlaneCharacter = Cast<APlaneCharacter>(CharacterOwner);
		if (!PlaneCharacter)
		{
			return;
		}
		...
		if (!HasAnimRootMotion() && !CurrentRootMotion.HasOverrideVelocity())
		{
			...
			PlaneCharacter->FlyingTick(timeTick, (remainingTime >= MIN_TICK_TIME) && (Iterations < MaxSimulationIterations));
		}
